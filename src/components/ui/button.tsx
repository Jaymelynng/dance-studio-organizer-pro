  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        elegant: "bg-gradient-primary text-primary-foreground shadow-elegant hover:shadow-soft transform hover:scale-105",
        professional: "bg-primary-dark text-primary-foreground shadow-card hover:bg-primary hover:shadow-elegant",
        success: "bg-success text-success-foreground shadow-soft hover:bg-success/90 transform hover:scale-105",
        warning: "bg-warning text-warning-foreground shadow-soft hover:bg-warning/90",
      },
      size: {
        default: "h-11 px-4 py-2 min-h-[44px]", // Better mobile touch target
        sm: "h-10 rounded-md px-3 min-h-[40px]",
        lg: "h-12 rounded-md px-8 min-h-[48px]",
        icon: "h-11 w-11 min-h-[44px] min-w-[44px]", // Proper mobile touch target
      },
    },
    defaultVariants: {
      variant: "default",
